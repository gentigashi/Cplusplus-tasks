...
//  exercise06A
//
//  Created by Genti Gashi on 12.11.2020.
...
int main() { //Exercise4 preset main function
    ...
    {
    cout<<"Time1 > is not smaller  than Time2."<<endl;
    }
    ...
    {
        cout<<"Time1 is not Bigger than Time2."<<endl;
    }
...
bool Time::operator==(const Time& sub)
{
